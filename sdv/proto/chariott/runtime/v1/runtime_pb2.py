...
_INTENTSERVICEREGISTRATION = DESCRIPTOR.message_types_by_name['IntentServiceRegistration']
...
_INTENTSERVICEREGISTRATION_EXECUTIONLOCALITY = _INTENTSERVICEREGISTRATION.enum_types_by_name['ExecutionLocality']
_INTENTREGISTRATION_INTENT = _INTENTREGISTRATION.enum_types_by_name['Intent']
IntentServiceRegistration = _reflection.GeneratedProtocolMessageType('IntentServiceRegistration', (_message.Message,), {
...
AnnounceResponse = _reflection.GeneratedProtocolMessageType('AnnounceResponse', (_message.Message,), {
...
IntentRegistration = _reflection.GeneratedProtocolMessageType('IntentRegistration', (_message.Message,), {
...
FulfillRequest = _reflection.GeneratedProtocolMessageType('FulfillRequest', (_message.Message,), {
...
FulfillResponse = _reflection.GeneratedProtocolMessageType('FulfillResponse', (_message.Message,), {
